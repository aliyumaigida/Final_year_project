    ...
    if request.method == 'POST':
        try:
            ...
            if request.FILES.get('csv_file'):
                ...
                # Prepare results
                results = [
                    f"Patient_ID {i + start_index}: {'Cancerous (Malignant)' if pred > 0.5 else 'Non-cancerous (Benign)'}"
            ...
            # === Manual Form Input Path ===
                ...
                result = "Cancerous (Malignant)" if prediction > 0.5 else "Non-cancerous (Benign)"
